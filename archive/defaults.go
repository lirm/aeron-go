...
type Defaults struct {
	...
	ControlTimeout         time.Duration      // How long to try sending/receiving control messages [see Proxy.Timeout]
	...
	RecordingEventsChannel string             // Recording progress events
	RecordingEventsStream  int32              // and stream
	RecordingIdleStrategy  idlestrategy.Idler // Idlestrategy for the recording
}
