...
func NewContext() *Context {
	...
	ctx.availableImageHandler = func(ImageInterface) {}
	ctx.unavailableImageHandler = func(ImageInterface) {}
...
func (ctx *Context) AvailableImageHandler(handler func(ImageInterface)) *Context {
	ctx.availableImageHandler = handler
	return ctx
}

// UnavailableImageHandler sets an optional callback for unavailable image notification
func (ctx *Context) UnavailableImageHandler(handler func(ImageInterface)) *Context {
