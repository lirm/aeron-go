...
// If ImageInterface changes, recreate the mock code with the below command.
// mockery --name=ImageInterface --inpackage --structname=MockImage --print
...
// MockImage is an autogenerated mock type for the ImageInterface type
